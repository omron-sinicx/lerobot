...
def to_hf_dataset(data_dict, video) -> Dataset:
    ...
    if "observation.eef.pos" in data_dict:
        features["observation.eef.pos"] = Sequence(
            length=data_dict["observation.eef.pos"].shape[1], feature=Value(dtype="float32", id=None)
        )
    ...
    # if "observation.tactile.image" in data_dict:
    #     features["observation.tactile.image"] = Sequence(
    #         length=data_dict["observation.tactile.image"].shape[1], feature=Value(dtype="float32", id=None)
    #     )
