...
#Adding a Transfomer block to the hugging face lerobot project diffusion model, to be used as an extra option next to the film layer, would replace the unet model I think? 
