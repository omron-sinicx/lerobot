...
$ python visualize_dataset.py --repo-id contactile --episode-index 1 --root /root/osx-ur/dependencies/datasets
...
def visualize_dataset(
    ...
    for batch in tqdm.tqdm(dataloader, total=len(dataloader)):
        ...
        for i in range(len(batch["index"])):
            ...
            if "observation.contactile" in batch:
                flattened_array = batch['observation.contactile'][i].numpy() # shape: (11, 3)
                reshaped_array = flattened_array.reshape(11, 3)
                global_x_force = reshaped_array[9][0]
                global_y_force = reshaped_array[9][1]
                global_z_force = reshaped_array[9][2]
                global_x_torque = reshaped_array[10][0]
                global_y_torque = reshaped_array[10][1]
                global_z_torque = reshaped_array[10][2]
                rr.log("observation/contactile/g_force_z", rr.Scalar(global_z_force))
                rr.log("observation/contactile/g_force_y", rr.Scalar(global_y_force))
                rr.log("observation/contactile/g_force_x", rr.Scalar(global_x_force))
                rr.log("observation/contactile/g_torque_z", rr.Scalar(global_z_torque))
                rr.log("observation/contactile/g_torque_y", rr.Scalar(global_y_torque))
                rr.log("observation/contactile/g_torque_x", rr.Scalar(global_x_torque))
            
            if "observation.vive_tracker_pose" in batch:
                hoge = batch['observation.vive_tracker_pose'][i].numpy()
            ...
            blueprint = rrb.Blueprint(
                rrb.Horizontal(
                    ...
                    rrb.Vertical(
                        rrb.TimeSeriesView(
                            name="contactile force plot", 
                            contents=[
                                "+ /observation/contactile/g_force_z",
                                "+ /observation/contactile/g_force_y",
                                "+ /observation/contactile/g_force_x",
                            ]),
                        rrb.TimeSeriesView(
                            name="force plot", 
                            contents=[
                    ...
                    rrb.Vertical(
                        rrb.TimeSeriesView(
                            name="contactile torque plot", 
                            contents=[
                                "+ /observation/contactile/g_torque_z",
                                "+ /observation/contactile/g_torque_y",
                                "+ /observation/contactile/g_torque_x",
                            ]),
                        rrb.TimeSeriesView(
                            name="torque plot", 
                            contents=[
